      ...
      <header className="px-6 py-4 border-b border-gray-200 dark:border-[#2A2A40] bg-white/60 dark:bg-[#0f0f18]/60 backdrop-blur-sm sticky top-0 z-40">
        <div className="max-w-6xl mx-auto w-full flex items-center gap-4">
          ...
          <a
            ...
            className="ml-auto inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-300 hover:bg-indigo-100 dark:hover:bg-indigo-900/50 transition-colors text-[12px] font-medium"
          >
            {/* Discord brandmark — Bootstrap Icons version (16×16 viewBox, clean
                winding so the eyes render as proper cutouts at any size). */}
          ...
          <button
            ...
            className="inline-flex items-center gap-1 px-3 py-1.5 rounded-full bg-blue-600 text-white hover:bg-blue-700 transition-colors text-[12px] font-medium shadow-sm"
          >
