import { BookOpen, MessageSquare, Layers, FileText, Target, ClipboardCheck, PenTool, Settings, Swords, GraduationCap, Users, Shield, Zap, Lightbulb, Calculator, Gem } from 'lucide-react';
...
const APP_REGISTRY = [
  ...
  { id: 'gems', label: 'Minds', icon: Gem, color: '#8b5cf6', gradient: 'from-violet-500 to-purple-600' },
