import { BookOpen, MessageSquare, Layers, FileText, Target, ClipboardCheck, PenTool, Settings, Swords, GraduationCap, Users, Shield, Zap, Lightbulb, Calculator, Brain } from 'lucide-react';
...
const APP_REGISTRY = [
  ...
  { id: 'gems', label: 'Minds', icon: Brain, color: '#8b5cf6', gradient: 'from-violet-500 to-purple-600' },
