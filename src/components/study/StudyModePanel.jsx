      ...
      <div className="flex items-center gap-2.5">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[10px] text-gray-500 dark:text-gray-400 tabular-nums">
            ...
            {sourceMode && <span className="ml-2 inline-flex items-center gap-1 text-amber-600 dark:text-amber-400 font-semibold uppercase tracking-wider"><span className="w-1 h-1 rounded-full bg-amber-500" /> Source mode · 2×</span>}
          </p>
        </div>
        <button
